  ...
  (define value-of/k
    (lambda (exp env cont)
      (cases expression exp
        ...
        (list-exp (exps)
          (value-of/k (car exps) env (list-cont1 (cdr exps) env cont))
        )
  ...
  (define apply-cont
    (lambda (cont val)
      (cases continuation cont
        ...
        (list-cont (lst exps saved-env saved-cont)
          (if (null? exps) 
                (saved-cont lst)
                ((value-of/k (car exps) saved-env (list-cont (pair-val val lst) (cdr exps) saved-env saved-cont)))))
